#!/bin/bash
# =============================================================================
# SplitWire Kontrol Paneli GUI - macOS 26 Uyumlu
# =============================================================================
...
tell application "System Events"
    activate
    set theResult to display dialog "$MSG_TEXT" & return & return & "$STATUS_MSG" with title "SplitWire Kontrol Paneli v2.0" buttons {"$BTN_CANCEL", "$BTN_SEC", "$BTN_MAIN"} default button "$BTN_MAIN" with icon $ICON
...
case "$USER_CHOICE" in
    ...
    "Yeniden Başlat")
        ...
        ;;
    "Sistem Bilgisi")
        # Sistem bilgisini topla ve göster
